...
### Action Buttons
- **Style**: Sentence case
- **Pattern**: First person ("I") for user choices, imperative for actions
- **Max length**: 3-4 words

### Rules of thumb for buttons
- If the user is making a choice about themselves → use "I" / "my"
- If the user is choosing something about the system → name the system
